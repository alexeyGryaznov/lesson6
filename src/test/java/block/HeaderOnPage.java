...
public class HeaderOnPage {
    ...
    @Step("Вызов формы входа на сайт с логином и паролем")
    ...
    @Step("Ввод логина и пароля на сайте")
    public HeaderOnPage InputDataInLoginForm(String testLogin, String testPassword) {
        Allure.parameter("Вход на сайт с Логином: ", testLogin);
        Allure.parameter("Вход на сайт с Паролем: ", testPassword);
    ...
    @Step("Ввод нового местоположения {location} в форму локации")
    public HeaderOnPage InputCityToForm(String location) {
        Allure.parameter("Смена локации на:", location);
    ...
    @Step("Проверка смены локации в header")
    ...
    @Step("Авторизация на сайте с использованием Cookie")
    ...
    @Step("Ввод данных {product} в форму поиска на сайте через Header")
    public HeaderOnPage InputSearchProduct(String product) {
        Allure.parameter("Покупка товара:", product);
